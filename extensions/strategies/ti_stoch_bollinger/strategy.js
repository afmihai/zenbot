...
const ti_stoch = require('../../../lib/ti_stoch')
const ti_bollinger = require('../../../lib/ti_bollinger')
      ...
      .then(function (inbol) {
        ti_stoch(
          ...
          .then(function (inres) {
            ...
            const divergent =
              inres.k[inres.k.length - 1] - inres.d[inres.d.length - 1]
