...
module.exports = {
  ...
  getOptions: function () {
    ...
    this.option(
      'lastpoints',
      'Number of trades for short trend average',
      Number,
      100
    )
    this.option(
      'avgpoints',
      'Number of trades for long trend average',
      Number,
      1000
    )
    this.option(
  ...
  onReport: function (s) {
    ...
    cols.push(' ')
    cols.push(
      z(8, n(s.stats).format('0.00000000'), ' ')[
        s.growth === true ? 'green' : 'red'
      ]
    )
    cols.push(' ')
    cols.push(
      z(8, n(s.stats2).format('0.00000000'), ' ')[
        s.growth2 === true ? 'green' : 'red'
      ]
    )
    cols.push(' ')
    cols.push(
      z(8, n(s.stdevs).format('0.00000000'), ' ')[
        s.accel === true ? 'green' : 'red'
      ]
    )
    cols.push(' ')
    cols.push(
      z(8, n(s.stdevl).format('0.00000000'), ' ')[
        s.accel === true ? 'green' : 'red'
      ]
    )
    cols.push(' ')
    cols.push(
      z(8, n(s.means).format('0.00000000'), ' ')[
        s.accel === true ? 'green' : 'red'
      ]
    )
    cols.push(' ')
    cols.push(
      z(8, n(s.meanl).format('0.00000000'), ' ')[
        s.accel === true ? 'green' : 'red'
      ]
    )
    cols.push(' ')
    cols.push(
      z(8, n(s.options.markup_sell_pct).format('0.00000000'), ' ')[
        s.accel === true ? 'green' : 'red'
      ]
    )
    return cols
