...
const ta_stoch = require('../../../lib/ta_stoch')
...
module.exports = {
  ...
  onReport: function (s) {
    ...
    if (s.period.bollinger) {
      if (s.period.bollinger.upperBound && s.period.bollinger.lowerBound) {
        ...
        cols.push(
          z(8, n(s.period.stoch_D).format('0.0000').substring(0, 7), ' ').cyan
        )
        cols.push(
          z(8, n(s.period.stoch_K).format('0.0000').substring(0, 7), ' ').cyan
        )
        cols.push(
  ...
  phenotypes: {
    ...
    stoch_k_ma_type: Phenotypes.ListOption([
      'SMA',
      'EMA',
      'WMA',
      'DEMA',
    ...
    stoch_d_ma_type: Phenotypes.ListOption([
      'SMA',
      'EMA',
      'WMA',
      'DEMA',
