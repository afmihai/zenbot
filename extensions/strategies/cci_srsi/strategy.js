...
module.exports = {
  ...
  getOptions: function () {
    ...
    this.option(
      'oversold_cci',
      'buy when CCI reaches or drops below this value',
      Number,
      -90
    )
    this.option(
      'overbought_cci',
      'sell when CCI reaches or goes above this value',
      Number,
      140
    )
  ...
  calculate: function (s) {
    ...
    if (
      typeof s.period.cci !== 'undefined' &&
      typeof s.period.srsi_K !== 'undefined'
    ) {
    ...
    if (!s.in_preroll && typeof s.trend !== 'undefined') {
      ...
      if (s.period.acc < s.options.ema_acc) {
        ...
        if (
          ...
          /*s.period.srsi_K > s.period.srsi_D &&*/ s.period.srsi_K <=
  ...
  onReport: function (s) {
    ...
    if (typeof s.period.cci === 'number') {
      ...
      cols.push(
        s.period.acc > s.options.ema_acc
          ? z(8, n(s.period.srsi_K).format('000'), ' ')[color]
          : '   -->   '
      )
    } else {
      cols.push('         ')
