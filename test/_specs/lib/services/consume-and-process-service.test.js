...
describe('consume-and-process-service', function () {
  describe('', function () {
    beforeEach(function () {
      ...
      mock(
        '../../../../lib/services/resume-marker-service',
        mockResumeMarkerService
      )
      service = mock.reRequire(
        '../../../../lib/services/consume-and-process-service'
      )
    })
    ...
    it('does what its supposed to', function (done) {
      ...
      var processFunc = (targetTimeInMillis, queue, nextTradeIdFunc, cb) => {
        ...
        else cb(null, false, arrayOfRecords[arrayOfRecords.length - 1].trade_id)
      }
