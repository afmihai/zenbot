...
describe('The Backfill Process function', function () {
  ...
  describe('processes trades ', function () {
    beforeEach(function () {
      spyOn(queue, 'dequeue').and.returnValue([
        { trade_id: 3002, time: 1517787104904 },
        { trade_id: 3001, time: 1517787104902 },
        { trade_id: 3000, time: 1517787104900 },
      ])
    })

    it('when all are considered new', function () {
      var callback = jasmine.createSpy('callback')
      var instance = mock.reRequire(
        '../../../../commands/backfill/backfill.process.function'
      )({})
