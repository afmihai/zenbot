...
function createEngine(
  ...
  var fake_return = {
    ...
    'exchanges.test_exchange': function () {
      return {
        getProducts: function () {
          return [fake_product]
        },
        getQuote: function (product, callback) {
          callback(null, { bid: fake_bid, ask: fake_ask })
        },
        getBalance: function (args, callback) {
          return callback(null, fake_balance)
        },
        buy: buy_spy,
        name: fake_exchange,
        makerFee: 0.1,
  ...
  var exchange_path = path.resolve(
    __dirname,
    '../../extensions/exchanges/test_exchange/exchange'
  )
