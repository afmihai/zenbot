...
const SELL_THRESHOLD_MIN = 0
const SELL_THRESHOLD_MAX = 10

const SELL_THRESHOLD_MAX_MIN = 0
const SELL_THRESHOLD_MAX_MAX = 10

const BUY_THRESHOLD_MIN = 0
const BUY_THRESHOLD_MAX = 10

const SELL_MIN_MIN = 0
const SELL_MIN_MAX = 10
