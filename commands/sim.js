    ...
    .action(function (selector, cmd) {
      ...
      function exitSim() {
        ...
        options_output.simresults.vs_buy_hold =
          n(s.balance.currency).subtract(buy_hold).divide(buy_hold).value() *
          100.0
